...
export default function Welcome({ auth, laravelVersion, phpVersion, admin }) {
    return (
        <>
            <Head title="Welcome" />
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                <div className="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    {auth.user ? (
                        //link component that checks if the user is admin then takes me to admin page if the user is an admin
                        (auth.user.role === 'admin' ? (
                            <>
                              <Link
                                href='/admin'
                                className="font-semibold mx-3 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                              >
                                Admin
                              </Link>
                              <Link
